    ...
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            ...
            <div class="nk-block-des text-soft">
                <p>You have total <?= count($trainings) ?> training records.</p>
            </div>
        </div>
        ...
        <div class="card-inner">
            ...
            <ul class="preview-list">
                <li class="preview-item">
                    <span class="badge badge-dot bg-success"><?= count($done) ?> Done</span>
                </li>
                <li class="preview-item">
                    <span class="badge badge-dot bg-danger"><?= count($cancel) ?> Cancelled</span>
                </li>
                <li class="preview-item">
                    <span class="badge badge-dot bg-info"><?= count($ongoing) ?> Ongoing</span>
                </li>
                <li class="preview-item">
                    <span class="badge badge-dot bg-secondary"><?= count($draft) ?> Draft</span>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                <div class="drodown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <ul class="link-list-opt no-bdr">
                                            <li><a href="/training/show/<?= $training->id ?>"><em class="icon ni ni-eye"></em>Show<span></span></a></li>
                                            <li><a href="/training/edit/<?= $training->id ?>"><em class="icon ni ni-pen"></em>Edit<span></span></a></li>
                                            <li><a href="javascript:void(0)" onclick="onclickDelete(<?= $training->id ?>)"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
