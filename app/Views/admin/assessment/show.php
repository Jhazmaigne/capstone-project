...
<div class="nk-block nk-block-lg">
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="nk-block-title">Viewing <?= ucfirst($assessment->title) ?></h4>
        </div>
        <div class="nk-block-des text-soft mt-1">
            <p>Assessment for <?= ucfirst($assessment->training->topic) ?></p>
        </div>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="data">
                                <div class="data-group">
                                    <!-- DATA -->
                                    <div class="amount"><?= count($assessment->questions) ?></div>
                    ...
                    <div class="nk-ecwg nk-ecwg6">
                        <div class="card-inner">
                            ...
                            <div class="data">
                                <div class="data-group">
                                    <!-- DATA -->
                                    <div class="amount"><?= count($assessment->responses) ?></div>
                                    <div class="nk-ecwg6-ck">
            ...
            <table class="datatable-init table">
                <thead>
                    <tr>
                        ...
                        <th width="15%">Choice 1</th>
                        <th width="15%">Choice 2</th>
                        <th width="15%">Choice 3</th>
                        <th width="15%">Choice 4</th>
                        <th width="45%">Correct Answer</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($assessment->questions as $question) : ?>
                        <tr>
                            ...
                            <td><?= $question->correct_answer->description ?></td>
                            <td>
                                <div class="drodown">
                ...
                <tbody>
                    <?php foreach ($assessment->responses as $response) : ?>
                        <tr>
                            ...
                            <td><?= count($response->correct_answers) ?></td>
                            <td>
                                <div class="drodown">
                                    <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                    <div class="dropdown-menu dropdown-menu-end">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/question/store" method="POST">
                    <input type="hidden" name="is_assessment" value="true">
...
<form action="/question/delete" method="POST" id="deleteForm">
    ...
    <input type="hidden" name="is_assessment" value="true">
    <input type="hidden" name="questionnaire_id" value="<?= $assessment->id ?>" />
</form>
<script>
